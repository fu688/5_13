...
- (void)viewDidLoad {
    ...
    self.textFiled.leftViewMode = UITextFieldViewModeUnlessEditing;
...
//
    ...
    self.textFiled1.leftView  = self.label1;
    self.textFiled1.leftViewMode = UITextFieldViewModeUnlessEditing;
    ...
    self.textFiled2.leftView  = self.label2;
    self.textFiled2.leftViewMode = UITextFieldViewModeUnlessEditing;
