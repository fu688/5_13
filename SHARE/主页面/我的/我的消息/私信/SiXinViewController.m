...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[SiXinTableViewCell class] forCellReuseIdentifier:@"000"];
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    SiXinTableViewCell* cell = [self.tableView dequeueReusableCellWithIdentifier:@"000" forIndexPath:indexPath];
    cell.backgroundColor  = [UIColor whiteColor];
    cell.label.text = self.array1[indexPath.row];
    cell.label1.text = @"感谢你的关注";
